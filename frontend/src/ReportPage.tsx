...
export function ReportPage({ apiBaseUrl, analysisId }: ReportPageProps) {
  ...
  return <main className="report-main">
    <a className="back-link" href={`#discover/${encodeURIComponent(result.work_id)}`}>← Back to paper</a>
